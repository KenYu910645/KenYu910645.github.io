...
<div class="row">
    <div class="col-sm-12">
        {% include video.html path="https://www.youtube.com/embed/C65tufKgbUc" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

<div class="row">
    <div class="col-sm-12">
        {% include video.html path="https://www.youtube.com/embed/C8D1NWTPjJE" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
